...
export class RichTextViewDoc extends BaseDocsBlock {
    ...
    override config: TDocConfig = {
        ...
        bySkin: {
            ...
            [TSkin.UUI3_loveship]: {
                type: '@epam/loveship:RichTextViewProps',
                component: loveship.RichTextView,
                doc: (doc: DocBuilder<loveship.RichTextViewProps>) => {
            ...
            [TSkin.UUI4_promo]: {
                type: '@epam/promo:RichTextViewProps',
                component: promo.RichTextView,
                doc: (doc: DocBuilder<promo.RichTextViewProps>) => {
