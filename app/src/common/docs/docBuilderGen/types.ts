...
export type TDetailsBuilder = (params: { docs: DocBuilder<any>, prop: TTypeProp, skin: TSkin }) => (Partial<PropDoc<any, any>> | undefined);
...
export type TDocOverrideBySkin<K = any> = (doc: DocBuilder<K>, skin: TSkin) => void;
