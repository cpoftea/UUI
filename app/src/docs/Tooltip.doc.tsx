        ...
        bySkin: {
            [TSkin.UUI]: {
                ...
                doc: (doc: DocBuilder<uui.TooltipProps>) => {
                    doc.merge('children', {
                        examples: [{ value: <uui.Button mode="solid" size="36" caption="Button" />, name: 'Solid button', isDefault: true }],
                    });
                    doc.merge('color', { renderEditor: undefined });
                },
            },
            [TSkin.UUI3_loveship]: {
                ...
                doc: (doc: DocBuilder<loveship.TooltipProps>) => {
                    doc.merge('children', {
                        examples: [{ value: <loveship.Button mode="solid" size="36" caption="Button" />, name: 'Solid button', isDefault: true }],
                    });
                },
            },
            [TSkin.UUI4_promo]: {
                ...
                doc: (doc: DocBuilder<promo.TooltipProps>) => {
                    doc.merge('children', {
                        examples: [{ value: <promo.Button mode="solid" size="36" caption="Button" />, name: 'Solid button', isDefault: true }],
                    });
                },
            },
        },
