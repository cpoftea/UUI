...
import { buildPropDetails, buildPropFallbackDetails, FALLBACK_RENDER_EDITOR } from './propDetailsBuilders/build';
    ...
    if (forSkin) {
        ...
        unresolvedProps.forEach((prop) => {
            ...
            if (isPropNotComplete) {
                docs.merge(prop.name, { renderEditor: FALLBACK_RENDER_EDITOR });
            }
        });
