...
export class SpinnerDoc extends BaseDocsBlock {
    ...
    override config: TDocConfig = {
        ...
        bySkin: {
            ...
            [TSkin.UUI3_loveship]: { type: '@epam/uui:SpinnerProps', component: loveship.Spinner, doc: (doc: DocBuilder<loveship.ButtonProps>) => doc.withContexts(loveshipDocs.FormContext, loveshipDocs.ResizableContext) },
            [TSkin.UUI4_promo]: { type: '@epam/uui:SpinnerProps', component: promo.Spinner, doc: (doc: DocBuilder<promo.ButtonProps>) => doc.withContexts(promoDocs.FormContext, promoDocs.ResizableContext) },
        },
    };
